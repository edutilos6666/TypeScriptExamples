import complexNumber = require("./ComplexNumber")
import inheritanceExample = require("./InheritanceExample")
import objects = require("./Objects")
import namespaceExample = require("./NamespaceExample")
...
function testNamespaceExample() {
    ...
    var cnSub:namespaceExample.com.edutilos.src.ComplexNumber2 = cn3.sub(cn4)
...
function testInheritanceExample() {
    ...
    console.log("\n<<CustomFile>>")
    var file:inheritanceExample.CustomFile = new CustomFile("foobar.txt", "4,2,1");
    ...
    var workers = new Array<inheritanceExample.Worker>()
